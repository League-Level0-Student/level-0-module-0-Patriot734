...
public class QuizGame {
	public static void main(String[] args) {
		...
		String question2 = JOptionPane.showInputDialog("What is the first name of the Patriot's quaterback?");
		// 2. Ask the user a question
		if (question2.contentEquals("Tom")) 
		{
			String prompt = "Correct";
			JOptionPane.showMessageDialog(null, prompt);
			score = score + 1;
		...
		String fc = "your final score was " + score;
